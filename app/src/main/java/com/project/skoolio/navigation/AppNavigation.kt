...
import com.project.skoolio.screens.Fee.CreateFeesScreen
...
//        }
        ...
        composable(AppScreens.MonthlyPaymentDetailsScreen.name){
            MonthlyPaymentDetailsScreen(navController, viewModelProvider)
        }
