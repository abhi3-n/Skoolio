        ...
        viewModelScope.launch {
            ...
            if(_loginResponse.value.data.status == "Approved") {
                ...
                if (userType.value == "Student") {
                    studentDetails.schoolName.value = capitalize(backend.getSchoolNameForSchoolId((_loginResponse.value.data as StudentLoginResponse).student.studentSchoolDetails.schoolId.toString()).schoolName)
                    ...
                    teacherDetails.employingSchoolName.value = capitalize(backend.getSchoolNameForSchoolId((_loginResponse.value.data as TeacherLoginResponse).teacher.teacherSchoolDetails.schoolId.toString()).schoolName)
